                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="subcategories" id="tagsinput-default" class="form-control" value="Amsterdam,Washington,Sydney" data-role="tagsinput" />
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary">Create Variation</button>
                </div>
            </div>
        </div>
    </div>
